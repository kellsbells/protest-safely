...
function submitProtestEvent(event) {
...
function submitPoliceEvent(event){
    event.preventDefault();
...
function writeNewEvent(type, lat, long, formValues) {
    var postData = {
        type: type,
        lat: lat,
        long: long,
